# Steps to run the contracts with truffle and ganache
* install truffle and ganache
* run ganache. eq: ganache-cli. It will output the address of the contract, you will use it below
* config truffle.json to connect to ganache server(local simulation of a blockchain)
* truffle migrate
* truffle console
    * Fib.new()
    * Fib.at("<enter_contract_address_here>").fib(10)

    * Concat.new()
    * Concat.at("<enter_contract_address_here>").concat(10)

    * Xor.new()
    * Xor.at("<enter_contract_address_here>").xor("true","false")
